										...
										<?php if(!empty($album_details_array['apple_music'])) { ?>
											<div class="col-xs-12 col-sm-6">
												<a href="<?php echo esc_url($album_details_array['apple_music']) ?>" class="app-button app-store">
													<span class="t"><?php echo esc_html__( 'Download From', 'sansara' ) ?></span>
													<span class="l"><?php echo esc_html__( 'Apple Music', 'sansara' ) ?></span>
												</a>
											</div>
										<?php } if(!empty($album_details_array['google_play'])) { ?>
											<div class="col-xs-12 col-sm-6">
												<a href="<?php echo esc_url($album_details_array['google_play']) ?>" class="app-button google-play">
													<span class="t"><?php echo esc_html__( 'Download From', 'sansara' ) ?></span>
													<span class="l"><?php echo esc_html__( 'Google Play', 'sansara' ) ?></span>
												</a>
											</div>
										<?php } if(!empty($album_details_array['soundcloud'])) { ?>
											<div class="col-xs-12 col-sm-6">
												<a href="<?php echo esc_url($album_details_array['soundcloud']) ?>" class="app-button sound-cloud">
													<span class="t"><?php echo esc_html__( 'Listen On', 'sansara' ) ?></span>
													<span class="l"><?php echo esc_html__( 'Sound Cloud', 'sansara' ) ?></span>
												</a>
											</div>
										<?php } if(!empty($album_details_array['spotify'])) { ?>
											<div class="col-xs-12 col-sm-6">
												<a href="<?php echo esc_url($album_details_array['spotify']) ?>" class="app-button spotify">
													<span class="t"><?php echo esc_html__( 'Available On', 'sansara' ) ?></span>
													<span class="l"><?php echo esc_html__( 'Spotify', 'sansara' ) ?></span>
												</a>
											</div>
										<?php } ?>
									</div>
